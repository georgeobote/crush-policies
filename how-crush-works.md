...
- **Three drop slots:** Morning (10–11 AM), afternoon (3–4 PM), and evening (8–9 PM) in your school’s time zone. Each day we pick one shared random minute per window (per zone/campus), so the reveal feels like a “BeReal” moment for everyone nearby.
...
- Tap **Like** to lean in or **Pass** to skip. Both people must tap Like before chat unlocks—classic double opt-in. You can also tap **Later** to revisit from the Daily Drops list before the response timer expires.
...
- Curious about the nitty-gritty? The [data inventory](../privacy/data-inventory.md) lists every collection, field (including lifestyle + compatibility signals), and retention promise.
